...
- [X] Escrever **README.md** técnico detalhado (instalação, uso, decisões).
- [X] Criar **Diagrama de Arquitetura** (Mermaid.js ou imagem).
- [X] Commit final e envio do link do repositório.
